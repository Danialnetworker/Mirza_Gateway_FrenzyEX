...
function self_update_script() {
    ...
    local URL="https://raw.githubusercontent.com/Danialnetworker/Mirza_Gateway_FrenzyEX/main/install.sh"
...
GIT_REPO="Danialnetworker/Mirza_Gateway_FrenzyEX"
...
function migrate_to_pro() {
    ...
    rm -rf "$OLD_BOT_DIR"
    mkdir -p "$NEW_BOT_DIR"
    ZIP_URL="https://github.com/Danialnetworker/Mirza_Gateway_FrenzyEX/archive/refs/heads/main.zip"
